...
for section in doc.sections():
    combined_context += section.to_html(include_children=True, recurse=True) + "\n"

# Questions and Answers
questions = [
    "What was Google's operating margin for 2024?",
    "What % Net income is of the Revenues?", 
    "What % growth in total income was there in the Segment Operating Results from 2023 to 2024?"
]

for question in questions:
    response = llm.complete(
        f"Read this content and answer the question:\n{question}\n{combined_context}"
    )
